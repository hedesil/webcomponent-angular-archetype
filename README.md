...
The `npm start` command runs `ng server` on port `4200`.
...
* `npm start` - runs the compiler and a server at the same time to watch the basic component on a traditional Angular app.".
